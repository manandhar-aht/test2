...
--
-- Data for Name: maintenance_history; Type: TABLE DATA; Schema: public; Owner: geouser
--

COPY public.maintenance_history (id, feature_id, maintenance_date, maintenance_type, description, technician_name, cost, parts_replaced, hours_spent, next_maintenance_due, urgency_level, completion_status, before_photos, after_photos, notes, created_at) FROM stdin;
\.
...
--
-- Data for Name: spatial_ref_sys; Type: TABLE DATA; Schema: public; Owner: geouser
--
...
--
-- Data for Name: water_quality_history; Type: TABLE DATA; Schema: public; Owner: geouser
--

COPY public.water_quality_history (id, feature_id, test_date, ph_level, turbidity_ntu, tds_ppm, chlorine_residual_ppm, bacteria_count_cfu, nitrate_ppm, fluoride_ppm, arsenic_ppb, iron_ppm, manganese_ppm, hardness_ppm, conductivity_us_cm, temperature_c, dissolved_oxygen_ppm, test_lab, lab_technician, compliance_status, notes, created_at) FROM stdin;
\.
...
--
-- Data for Name: geocode_settings; Type: TABLE DATA; Schema: tiger; Owner: geouser
--
...
--
-- Data for Name: pagc_gaz; Type: TABLE DATA; Schema: tiger; Owner: geouser
--
...
--
-- Data for Name: pagc_lex; Type: TABLE DATA; Schema: tiger; Owner: geouser
--
...
--
-- Data for Name: pagc_rules; Type: TABLE DATA; Schema: tiger; Owner: geouser
--
...
--
-- Data for Name: topology; Type: TABLE DATA; Schema: topology; Owner: geouser
--
...
--
-- Data for Name: layer; Type: TABLE DATA; Schema: topology; Owner: geouser
--
...
--
-- Name: maintenance_history_id_seq; Type: SEQUENCE SET; Schema: public; Owner: geouser
--
...
--
-- Name: water_quality_history_id_seq; Type: SEQUENCE SET; Schema: public; Owner: geouser
--

SELECT pg_catalog.setval('public.water_quality_history_id_seq', 1, false);
...
--
-- Name: topology_id_seq; Type: SEQUENCE SET; Schema: topology; Owner: geouser
--
